...
let api_key = '2decf95c79ae8dddb06ae5ad10668488'
...
function mostrarDatosClima(data){
    ...
    sensacionTermicaInfo.textContent = `Sensación Térmica: ${Math.floor(sensacionTermica-difKelvin)}ºC`

    const iconoInfo = document.createElement('img')
    iconoInfo.src = `https://openweathermap.org/img/wn/${icono}.png`
    iconoInfo.classList.add('icono-clima')
